INSERT INTO `users` (`name`, `lastName`, `location`, `state`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`)
VALUES
('Zacharia', 'Azzouzi', 'Lyon', 2, 'zacharia.azzouziclausel@viacesi.fr', NULL, '$2y$10$h6ucQuo8QqiWMH9UjCdM.e7C0KuB3mdDwfQ6XngruuxfqfHC4DAgu', '1H1mWZhiAzZHNecWbBRCuVTfrOedMgCYtNrxgjTU0lR8MZiLB2e8kkV4ZzAR', '2019-01-22 11:53:34', '2019-01-22 14:45:34'),
('Niels', 'Boeckx', 'Lyon', 2, 'niels.boeckx@viacesi.fr', NULL, '$2y$10$82Vx1r/lbZzKt8To.qlgOeAOHBfSm9tH8ZV8DPYIsLwcZPD49Qghe', NULL, '2019-01-24 17:40:39', '2019-01-24 17:40:39'),
('Rémi', 'Papin', 'Lyon', 2, 'remi.papin@viacesi.Fr', NULL, '$2y$10$abvo7p26XXjpdYX1P7jYH.SQIGQ8fA8.cNKNONuHfcwEhWLitQsf2', NULL, '2019-01-24 17:41:28', '2019-01-24 17:41:28'),
('Guillaume', 'Woreth', 'Lyon', 2, 'guillaume.woreth@viacesi.fr', NULL, '$2y$10$fNgDQgo9D/ttrIj3Lgy0MO6Bg11srl44cUoO0foJNbj3ecILqvr16', NULL, '2019-01-24 17:42:14', '2019-01-24 17:42:14'),
('CESI1', 'CESI1', 'Angoulême', 1, 'bdewebsite1@gmail.com', NULL, '$2y$10$ZYUPHGlwfzn0VSs33SNXU.Okyj3qPnW4FficylBe1R3B5JINJoSAO', NULL, '2019-01-24 17:36:49', '2019-01-24 17:38:16'),
('USER1', 'USER1', 'Lyon', 0, 'bdewebsite2@gmail.com', NULL, '$2y$10$ZKqxxmIf9uzhkLHFSfdi7OryNRCZH49TvRkU4eahwxJ9Qhlafsu3K', NULL, '2019-01-24 17:39:47', '2019-01-24 17:39:47');
...
('niels.boeckx@viacesi.fr','Urbex','2019-02-25','Viens decouvrir des lieux impressionnants',0,'https://i.ytimg.com/vi/CWnZvVaYpsU/maxresdefault.jpg',0, 7,'0', 0, NULL, NULL),
...
('remi.papin@viacesi.fr','Battle Dev','2019-03-25','Viens dévelloper ton application dans une ambiance relax',0,'https://cibul.s3.amazonaws.com/review_la-battle-dev-revient-en-force-le-22-mars_00.jpg',0,8,'0', 0, NULL, NULL),
...
INSERT INTO `articles` (`name`, `description`, `quantity`, `price`, `sold`, `imageLink`, `categorie`)
VALUES
('Tasse', 'Voici une tasse sombre comme votre IDE favoris.', 25, 5, 0, 'https://cdn1.ideecadeau.fr/media/catalog/product/l/a/la-tasse-magique-ideecadeau-fr_5451-4ed425a6.jpg', 'goodies'),
('Pull', 'Pull en pur coton, idéale pour l\'hiver au coin du feu.', 600, 26, 0, 'https://media.idkids.fr/media/productstorage/images/okaidi/0089069/thumbs/0125959_800.jpg', 'vetement'),
('Porte-Clefs', 'Tu en a marre de ne plus savoir quelle clé ouvre quoi, voici un porte clés pratique.', 100, 3, 0, 'https://media.rs-online.com/t_large/F7757728-01.jpg', 'goodies'),
('Coque', 'Voici une coque originale pour protéger ton téléphone.', 54, 12, 0, 'https://images-na.ssl-images-amazon.com/images/I/4136yBNhmzL._SY355_.jpg', 'goodies'),
('Casquette', 'Une casquette jeune et branché.', 70, 25, 0, 'https://www.vondutch.fr/2957-thickbox_default/casquette-baseball-homme-von-dutch-relief-bleu-marine.jpg', 'vetement'),
